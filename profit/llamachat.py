...
from email_drafter.marketing_report import generate_prospect_report
from email_drafter.email_generator import generate_email
...
class LlamaClarifaiChat:
    ...
    def generate_prospect_report(self):
        prospect_profile, prospect_report = generate_prospect_report()
